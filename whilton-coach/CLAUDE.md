...
- The lap time model is built on estimates: the hill (8 m, from words in the guides), the track width (8 m, the usual kart-circuit width), the lap length (the 1200 m map against the 1054 m in the 2025 regulations) and the kart's grip, traction and braking. A point mass has no yaw, no load transfer and no kerbs. With the published kart figures it is slower than the 56.99 s hire-kart record; the report's sensitivity rows show what closes the gap. Trust its relative results more than its lap time.
